...
def _build_prompt(reel_title: str, claim: str) -> str:
    ...
    return (
        ...
        "- If the claim contains a year (e.g. 1518, 1919, 1989), a country, "
        "  a named company, or a named event, include at least one in the "
        "  title. YouTube viewers search by year, place, and named entity. "
        "  Example: 'Boston Molasses Disaster 1919: 21 Dead' beats 'The Syrup "
        "  Wave That Killed 21' because nobody searches for 'syrup wave'.\n"
        "- The IG title may use a curiosity-gap shape ('Why nobody believed "
        "  him'). The YouTube title must be a search-shaped shape (named "
        "  subject + outcome).\n"
