...
def _build_prompt(recent_themes: list[str], allowed_categories: list[str]) -> str:
    ...
    return (
        ...
        "'sequels that are measurably better than the original', "
        "'films whose production nearly destroyed the studio', "
        "'directors whose debut the studio tried to bury', "
        "'TV shows that changed format completely after season one', "
        "'films scored by composers who had never done film before'.\n"
