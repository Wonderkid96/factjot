...
def _build_prompt(
    ...
    return (
        ...
        "Format:\n"
        "- Line 1-2: a punchy hook re-statement (the same fact, sharpened "
        "for YouTube search). 1-2 sentences max.\n"
        "- Blank line.\n"
        "- 3 source URLs (full clickable URLs, not just domains).\n"
        "- Blank line.\n"
        "- Exactly 5 hashtags: 1 broad + 3 niche + #Shorts (always last).\n"
        "- No clickbait shapes. No \"you won't believe\", \"mind-blowing\", "
        "\"this changed everything\", \"did you know\".\n\n"
        "British English. No em-dashes. Return the description text only."
    )
