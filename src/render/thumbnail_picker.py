...
def _build_score_prompt(claim: str, reel_title: str, frame_path: Path) -> str:
    ...
    return (
        ...
        "- TEXT OVERLAY LEGIBILITY: a bold white headline will be burned "
        "over the lower third of this frame. Penalise by 2 points if the "
        "bottom 30% of the image is bright, busy, or high-frequency "
        "texture, because white text would be illegible there. Prefer "
        "frames where the lower third is dark, uncluttered, or blurred.\n"
