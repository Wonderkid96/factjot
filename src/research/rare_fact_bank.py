...
RARE_FACT_BANK = [
    ...
    },
    {
        ...
        "reel_script": (
            ...
            "The ant leaves the colony. "
            "It climbs the nearest plant. To exactly the right height. "
            "It bites down hard on a leaf. "
            "And holds there. Frozen. "
            "Until the fungus erupts from its head. "
            "Spreading new spores onto the ants below. "
            "Nature made this."
        ),
    },
    {
    ...
    },
    {
        ...
        "reel_script": (
            ...
            "All dancing. Day and night. Without music. Without rest. "
            "The city authorities built a stage and hired musicians. "
            "It made it worse. "
            "Their feet bled. Their hearts gave out. "
            "Some died of exhaustion. "
            "Nobody had given an order. Nobody had played music. "
            "It just... started. "
            "Five centuries later, no one has ever explained why."
        ),
    },
    {
        "topic": "history",
        ...
        "reel_script": (
            ...
            "He kept it in a jar in his basement. For decades. "
            "He drove it across America in the boot of his car. "
            "He sliced it into 240 sections. "
            "He posted pieces to researchers around the world. "
    ...
    # ---------- BIOLOGY ----------
    {
        ...
        "reel_script": (
            ...
            "Cut off a leg. It grows back. Perfect bone. Perfect muscle. Perfect nerve. "
            "Cut its spinal cord. It regrows. "
            "Damage its heart. It regrows. "
            "Take out part of its brain. It regrows that too. "
            "Transplant an eye from one axolotl to another. "
            "No rejection. "
            "Scientists study it to understand how humans might one day do the same. "
            "The axolotl is nearly extinct in the wild. "
    ...
    },
    {
        ...
        "reel_script": (
            ...
            "For a friend. Not for its young. For a friend. "
            "They keep track of who feeds them. And they pay it back. "
            "They adopt orphan young. They form lifelong bonds. "
            "We make vampires into monsters. "
            "But the real ones are some of the most generous animals alive. "
    ...
    },
    {
        ...
        "reel_script": (
            ...
            "Often at night. Often through cloud. How do they know where to go? "
            "The answer is stranger than anyone expected. "
            "In the back of a robin's eye are proteins called cryptochromes. "
            ...
            "Migratory birds can literally see the magnetic field of the planet. "
            "A glowing compass painted across the sky. "
            "We have the same proteins. We just lost the ability to use them. "
    ...
    },
    {
        ...
        "reel_script": (
            ...
            "Spread its arms and become a flatfish on the seafloor. "
            "Trail two arms and turn into a banded sea snake. "
            "At least 15 different species. "
            "And here's the trick. "
            "It picks which one to imitate based on which predator is nearby. "
            "Threat by a damselfish? Become the snake that eats damselfish. "
            "The only known animal that actively chooses its disguise. "
            "Improvising. Lying. "
            "Outsmarting predators that have hunted here for millions of years."
        ),
    },
    {
        "topic": "ocean",
        ...
        "reel_script": (
            ...
            "Most people called them myths. Then science found one. "
            "It's called the giant oarfish. "
            "It can grow to 11 metres long. Longer than a London bus. "
            ...
            "When they wash up on beaches, people photograph them in shock. "
            "The sea serpents in old sailor stories weren't legends. "
    ...
    },
    {
        ...
        "reel_script": (
            ...
            "An earthquake shakes 90 million tonnes of rock loose from a mountainside. "
            "It crashes into the bay. "
            "The water has nowhere to go. "
            "It rises. Higher than the Eiffel Tower. "
            "Higher than the Empire State Building. "
            "524 metres tall. "
            "The biggest wave ever recorded by humans. "
            "Trees were stripped from the cliffs. The forest scrubbed clean. "
            "Two fishing boats were anchored in the bay. "
            "They didn't drown. They surfed it. "
    ...
    },
    {
        ...
        "reel_script": (
            ...
            "Sealed for 5 and a half million years. "
            "No sunlight. No oxygen. Hydrogen sulfide. Methane. "
            "And yet... "
            ...
            "They feed on bacteria that pull energy from toxic chemicals in the rock. "
            "Not from the sun. "
            "An entire ecosystem. "
            "Cut off. Surviving. "
    ...
    },
    {
        ...
        "reel_script": (
            ...
            "Concentric rings of rock. Like a giant eye staring up at the sky. "
            "It can only really be seen from space. "
            "When astronauts first photographed it in the 1960s, "
            "no one had any idea what it was. "
            "A meteor crater? A volcano? "
            "We finally have an answer. "
            "It's a geological dome that slowly collapsed. "
            "Different rock layers eroded at different speeds. Leaving rings. "
            "One of the most striking shapes on the planet. "
    ...
    },
    {
        ...
        "reel_script": (
            ...
            "The reason? Salt-loving algae and bacteria. "
            "The lake is ten times saltier than the ocean. "
            "Most things can't live in it. But these organisms thrive. "
    ...
    },
    {
        ...
        "reel_script": (
            ...
            "Here is a specific place where it is measurably, detectably weaker. "
            "Hudson Bay. Canada. "
            ...
            "The ice is long gone. But the rock is still slowly rising. "
    ...
    },
    {
        ...
        "reel_script": (
            ...
            "Lake Nyos. "
            "Magma beneath it had been saturating the water with CO2 for years. "
            "Then something triggered it. A landslide. A tremor. Nobody is sure. "
            "One million tonnes of carbon dioxide erupted from the surface. "
            "A silent cloud. Cold. Heavy. Rolling down the hillside. "
            "Heavier than air, it flowed into every village. Into every home. "
            "1,746 people died in their sleep. "
            "3,500 livestock. Every bird. Every insect. "
            "No sound. No warning. "
            "Survivors woke next to everyone they knew... already gone. "
    ...
    },
    {
        ...
        "reel_script": (
            "Earth has a Moon. You know this. "
            "What you probably don't know is that Earth has a second companion. "
            "It's called Kamoʻoalewa. A small asteroid, about the size of a house. "
            "Orbiting near Earth for at least a century. "
            "Not a moon. Gravity hasn't captured it. But not free either. "
            "It traces a complex looping spiral around us. Year after year. "
            "Scientists studied its composition and found something strange. "
            "Its material matches the surface of our Moon. "
            "Kamoʻoalewa might be a fragment of the Moon itself. "
            "Broken off by an ancient impact. Drifting beside us ever since."
        ),
    },
    {
        "topic": "earth",
        ...
        "reel_script": (
            ...
            "Then... it stopped. "
            "For almost a billion years, nothing changed. "
            "No new body plans. No major evolution. Oxygen flatlined. "
            "Scientists call it the Boring Billion. "
            "And it terrifies them a little. "
            "Because we don't fully understand why it happened. Or why it ended. "
            "Then, around 800 million years ago, something triggered a cascade. "
            "Complex animals appeared. Then plants. Then us. "
            "A billion years of stagnation, then everything all at once. "
    ...
    # ---------- OCEAN ----------
    {
        ...
        "reel_script": (
            ...
            "When they move fast, bioluminescent plankton lights up around them. "
    ...
    },
    {
        ...
        "reel_script": (
            "In 1997, NOAA hydrophones picked up a sound from the Pacific. "
            "Not a whale. Not a submarine. Something else. "
            "Extraordinarily loud. Detectable by sensors thousands of kilometres apart. "
            "The profile matched no known geological event. No known animal. "
            "Scientists called it the Bloop. For years, no explanation. "
            "The location? Roughly 1,600 kilometres from Lovecraft's fictional R'lyeh. "
            "That did not help. "
            "We now think it was a massive icequake. A glacier fracturing under its own weight. "
    ...
    },
    {
        ...
        "reel_script": (
            ...
            "It found a ship. Ancient. Greek. Still standing. "
            ...
            "No bacteria to rot the wood. No currents to break the hull. "
            "Ships that sank here over thousands of years are still sitting there. "
    ...
    },
    {
        ...
        "reel_script": (
            ...
            "The Greenland shark. "
            "Scientists estimate they can live for at least 270 years. Some possibly 400. "
            "They grow barely a centimetre a year. "
            "They do not reach sexual maturity until roughly 150 years old. "
            "150 years of life before they can reproduce. "
            "The oldest vertebrate ever recorded. "
            "A creature that saw the Industrial Revolution. Both World Wars. "
            "Still swimming. "
            "Still alive. "
    ...
    },
    {
        ...
        "reel_script": (
            ...
            "It watched them come. It watched them go. "
            "And it has something no lab has replicated. "
            "Its blood is bright blue. "
            "It contains a compound called LAL. "
            "LAL reacts instantly to bacterial contamination. Any endotoxin. Any trace. "
            "The pharmaceutical industry uses it "
            "to test every injectable drug ever given to a human. "
            "Every vaccine. Every IV drip. "
            "Passed through the blood of an ancient crab. "
            "Half a billion years of evolution. "
            "Guarding every hospital on Earth."
        ),
    },
    {
        "topic": "ocean",
    ...
    },
    {
        ...
        "reel_script": (
            ...
            "Enough to crush unprotected tissue instantly. "
            "And there it was. "
            "A snailfish. "
            "Translucent. Pale. Barely 30 centimetres long. "
            "Drifting. Calm. "
            "The deepest vertebrate ever recorded. "
            "Permanent darkness. Crushing pressure. Near-freezing temperatures. "
    ...
    },
    {
        ...
        "reel_script": (
            ...
            "The megalodon. "
            "18 metres long. Three times the length of a great white. "
            "Teeth the size of a human hand. "
            "Bite force of 110,000 newtons. The strongest of any animal measured. "
            "It hunted whales. It bit them in half. "
            "Fossil whale bones carry megalodon bite marks right through them. "
            "It went extinct 3.6 million years ago. Nobody is sure why. "
    ...
    },
    {
        ...
        "reel_script": (
            "The leatherback sea turtle has no hard shell. "
            "A rubbery, ridged carapace. It can weigh 900 kilograms. "
            "The largest reptile on Earth. "
            "And it dives past 1,000 metres. "
            "Deeper than the light goes. Searching for jellyfish in the blackness. "
            "It regulates its own body temperature to stay warm in freezing water. "
    ...
    },
    {
        ...
        "reel_script": (
            ...
            "One fed them. One poked them gently with a stick. "
